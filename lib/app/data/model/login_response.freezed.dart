...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {bool status, String accessToken, String refreshToken, String tokenType});
}
...
class _$_LoginResponse implements _LoginResponse {
  ...
  @override
  String toString() {
    return 'LoginResponse(status: $status, accessToken: $accessToken, refreshToken: $refreshToken, tokenType: $tokenType)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, accessToken, refreshToken, tokenType);
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final String tokenType}) = _$_LoginResponse;
